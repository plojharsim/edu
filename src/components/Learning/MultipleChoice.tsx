  ...
  return (
    <div className="w-full max-w-xl mx-auto space-y-8 p-4">
      <div className="bg-card p-6 sm:p-8 rounded-[2rem] shadow-sm border-2 border-slate-50 dark:border-slate-800 flex flex-col items-center">
        ...
        <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 text-center break-words w-full">{question}</h3>
      </div>
        ...
        {options.map((option, idx) => {
          ...
          return (
            <Button
              ...
              className={cn(
                "h-auto min-h-[4rem] py-4 px-6 text-base sm:text-lg font-medium rounded-2xl border-2 transition-all duration-300 flex justify-between items-center bg-card text-left whitespace-normal break-words gap-4",
