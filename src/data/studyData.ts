    ...
    topics: [
      {
        ...
        items: [
          ...
          { term: 'euer / eure', definition: 'váš / vaše', category: 'Ostatní', options: ['náš / naše', 'můj / moje', 'jejich'] },
          { term: 'fein', definition: 'fajn, bezva', category: 'Ostatní', options: ['praktický', 'obrovský', 'útulný'] },
          { term: 'Garten', definition: 'zahrada', category: 'der', options: ['dům', 'koupelna', 'pokoj'] },
          { term: 'gemütlich', definition: 'útulný', category: 'Ostatní', options: ['praktický', 'obrovský', 'nový'] },
          { term: 'Haus', definition: 'dům', category: 'das', options: ['byt', 'zahrada', 'pokoj'] },
          { term: 'hinten', definition: 'vzadu', category: 'Ostatní', options: ['nahoře', 'dole', 'vpravo'] },
          { term: 'Küche', definition: 'kuchyně', category: 'die', options: ['ložnice', 'koupelna', 'zahrada'] },
          { term: 'oben', definition: 'nahoře', category: 'Ostatní', options: ['dole', 'vzadu', 'vpravo'] },
          { term: 'praktisch', definition: 'praktický', category: 'Ostatní', options: ['útulný', 'obrovský', 'fajn'] },
          { term: 'rechts', definition: 'vpravo', category: 'Ostatní', options: ['vlevo', 'nahoře', 'dole'] },
          { term: 'riesig', definition: 'obrovský', category: 'Ostatní', options: ['malý', 'praktický', 'útulný'] },
          { term: 'Schlafzimmer', definition: 'ložnice', category: 'das', options: ['kuchyně', 'koupelna', 'obývací pokoj'] },
          { term: 'unser / unsere', definition: 'náš / naše', category: 'Ostatní', options: ['váš / vaše', 'můj / moje', 'její'] },
          { term: 'unten', definition: 'dole', category: 'Ostatní', options: ['nahoře', 'vzadu', 'vpravo'] },
          ...
          { term: 'hungrig', definition: 'hladový', category: 'Ostatní', options: ['žíznivý', 'sytý', 'unavený'] },
          { term: 'durstig', definition: 'žíznivý', category: 'Ostatní', options: ['hladový', 'veselý', 'líný'] }
        ]
      }
    ]
  },
